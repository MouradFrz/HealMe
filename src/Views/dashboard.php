                                ...
                                <?php if (count(sessionVar("appointments"))) { ?>
                                    <?php foreach (sessionVar("appointments") as $app) { ?>
                                        <div class="flex flex-col justify-center mb-3">
                                            ...
                                            <p class="ml-4"><span class="font-bold ">Appointment date and time: </span><?= $app["date"] ?> at <?= $app["time"] ?></p>
                                            <p class="ml-4"><span class="font-bold ">Reservation date: </span><?= $app["created_at"]->toDateTime()->format("Y-m-d H:i:s") ?></p>
                                        </div>
                                    <?php } ?>
                                <?php } else { ?>
